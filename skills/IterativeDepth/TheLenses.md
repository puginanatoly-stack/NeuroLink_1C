...
**Focus:** Parse the exact words. Identify every stated requirement, constraint, preference. No interpretation вЂ” only what was said.
**Criteria output:** Criteria for every explicitly stated requirement.
**Example prompt variation:** "List every concrete, testable requirement explicitly stated in this request. Do not infer вЂ” only extract."
...
**Criteria output:** Criteria for stakeholder needs not in the original request.
...
**Criteria output:** Anti-criteria (what must NOT happen) and defensive criteria.
...
**Criteria output:** Criteria for durability, migration, and future-proofing.
...
**Focus:** Beyond functional correctness вЂ” the qualitative experience. Speed, elegance, surprise, delight, confidence, trust. What's the difference between "works" and "works beautifully"?
**Criteria output:** Quality-of-experience criteria that elevate from functional to euphoric.
...
**Focus:** Remove assumed constraints вЂ” what would we build with infinite time/resources? Then add extreme constraints вЂ” what if it had to work offline, in 100ms, with zero dependencies? Both directions reveal hidden assumptions.
**Criteria output:** Criteria that challenge assumptions and reveal what's truly essential.
**Example prompt variation:** "What constraints are we assuming that weren't stated? Remove them вЂ” what changes? Now impose extreme constraints вЂ” what's truly essential?"
...
**Criteria output:** Criteria derived from proven patterns and lessons from analogous solutions.
...
**Criteria output:** Criteria that reframe or expand the problem definition itself.
...
Draw from this catalog. The lenses are ordered concrete-to-abstract and common-to-specialized, so a short run reaching for the earlier ones covers the most universally useful ground вЂ” but pick whatever the problem calls for, in any order.

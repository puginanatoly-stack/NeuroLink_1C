...
- *Maps to: Each pass tests emerging understanding against a new angle, revising until the criteria model coheres*
...
- *Maps to: Multiple reasoning paths = multiple lenses on the same criteria extraction*
...
- *Maps to: Combining multiple criteria extraction passes = ensemble of requirements*
...
- *Maps to: Each iteration adds precision to criteria*

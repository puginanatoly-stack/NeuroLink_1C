...
```powershell
powershell.exe -NoProfile -File ".opencode/skills/meta-edit/scripts/meta-edit.ps1" -ObjectPath "<path>" -Operation <op> -Value "<val>"
```

### JSON mode (сложные/комбинированные)

```powershell
powershell.exe -NoProfile -File ".opencode/skills/meta-edit/scripts/meta-edit.ps1" -DefinitionFile "<json>" -ObjectPath "<path>"
```
